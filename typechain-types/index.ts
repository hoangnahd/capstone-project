...
export type { MerkleAirdropMinter } from "./contracts/MerkleAirdropMinter";
export { MerkleAirdropMinter__factory } from "./factories/contracts/MerkleAirdropMinter__factory";
